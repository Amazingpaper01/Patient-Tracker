      ...
      appBar: AppBar(
        ...
        title: IconButton(
          ...
          onPressed: (){
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Page_Doctor()), // go to home pages (staff/home.dart)
            );
          },
        ),
        actions: <Widget> [
          PopupMenuButton<String>(
            ...
            onSelected: (String value) async {
              if (value == 'logout'){                
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => LogIn()), // go to login page (main.dart)
                );
                patientList.clear();                 
              }
            },
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {  
                  if (sendChatRequest) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => chatScreenPage()), // go to chatScreen page (staff/chatScreen.dart)
                    ); 
                  }
                  else {
